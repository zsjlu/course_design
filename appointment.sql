...
    order_status tinyint(2) default '0' comment
'预约状态',

    sign_in_status tinyint(2) default '0'
comment '签到状态',

    sign_out_status tinyint(2) default '0'
comment '签离状态',
...
    admin_account varchar(64) not null comment
'管理员账号',
...
    reading_room_id varchar(32) not null
comment '阅览室编号',

    reading_room_id varchar(64) not null
comment '阅览室名称',
...
    foreign key(floor_id) references
floor(floor_id) on delete set null
